    ...
    async  fetchProtocol(casenr) {
      ...
      return axios({
        ...
        .then((response) => {
          ...
          this.interp = response.data.protocols.interpretation;
          ...
          console.log(response.data.protocols._id);
    ...
    update() {
        ...
        return axios({
          ...
          .then(() => {
            ...
            this.$swal(
              'Erfolgreich!',
              'Die Interpretation wurde erfolgreich aktualisiert!',
              'success',
            );
          ...
          .catch(() => {
            this.$swal(
              'Fehler!',
              'Die Interpretation konnte nicht aktualisiert werden!',
              'error',
            );
          });
      },
